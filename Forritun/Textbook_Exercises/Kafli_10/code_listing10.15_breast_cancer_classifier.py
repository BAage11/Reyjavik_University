# Blaðsíða 541 - Code Listing 10.15
...
# open file. Fix the error checking
  ...
  for line_str in input_file:
    line_str = line_str.strip()   # strip off end-of-line characters "\n"
    ...
    patient_tuple = id_str, diagnosis_str, int(a1), int(a2), int(a3), int(a4), int(a5), int(a6), int(a7), int(a8), int(a9)
...
def main():
  ...
  print("Done reading training date. \n")
