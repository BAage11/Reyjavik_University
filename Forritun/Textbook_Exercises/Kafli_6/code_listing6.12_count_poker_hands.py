# Blaðsíða 329-330 - Code listing 6.12
# Count poker hands
...
print("Hand counts by rank number: ", nothing_count, pair_count, two_pair_count, three_of_a_kind_count, straight_count, flush_count, full_house_count, four_of_a_kind_count, straight_flush_count, royal_flush_count)
