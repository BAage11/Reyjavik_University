# Blaðsíða 485-487 - Code listing 9.9-9.12
...
def pretty_print(ga_set, doi_set):
  ...
  print("{:15s} {:15d}".format("GA_DoI", len(ga_set.difference(doi_set))))
...
def main():
  """ Compare the Gettysburg Address and the Declaration of Independece. """
