# Blaðsíða 619-620 - Code listing 12.6 & 12.7
...
def gcd(bigger, smaller):
  ...
  while smaller != 0:             # 1. if smaller == 0, halt
    ...
    # print "calculation, big:{}, small:{}, rem:{}".format(bigger, smaller, remainder)
    # debugging
    bigger, smaller = smaller, remainder    # reapply
  return bigger

def lcm(a, b):
  """ Calculate the lowest common multiple of two positive integers. """
  return (a*b) // gcd(a,b)      # Equation 12.1, // ensure an int is returned
...
class Rational(object):
  ...
  def __add__(self, param):
    ...
    if type(param) == Rational:
      ...
      numerator_sum = (the_lcm * self.numer/self.denom) + (the_lcm * param.numer/param.denom)
...
five_tenths = Rational(5,10)
print(five_tenths.reduce_rational())

print(one_half==five_tenths)
